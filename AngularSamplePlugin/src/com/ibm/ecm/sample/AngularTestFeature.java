 ...
 * this plug-in. The feature does little more than load the Angular 2 TypeScript app.
 */
public class AngularTestFeature extends PluginFeature {
	...
	public String getDescription(Locale locale) {
		return "Angular 2 Sample Feature";
	}
	...
	public String getFeatureIconTooltipText(Locale locale) {
		return "Open the Angular 2 Sample";
	}
	...
	public String getContentClass() {
		return "angularSamplePluginDojo.AngularTestFeature";
	}
	...
	public String getConfigurationDijitClass() {
		return "angularSamplePluginDojo.FeatureConfigurationPane";
	}
}
