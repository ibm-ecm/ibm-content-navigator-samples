...
public class DocuSignItemContextMenu extends PluginMenu {
	...
	public PluginMenuItem[] getMenuItems() {
		...
		return new PluginMenuItem[] { new PluginMenuItem("View"), new PluginMenuItem("Preview"), 
			...
			new PluginMenuItem("docuSign.action.SignSubmitAction"), new PluginMenuItem("docuSign.action.DocumentHistoryAction"), new PluginMenuItem("docuSign.action.CheckinAction"), new PluginMenuItem("docuSign.action.SignStatusAction"), new PluginMenuItem("Separator"),
