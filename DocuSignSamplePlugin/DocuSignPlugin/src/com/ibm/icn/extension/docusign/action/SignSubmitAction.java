...
public class SignSubmitAction extends PluginAction {

	private final static String CONST_ACTION_ID = "docuSign.action.SignSubmitAction";
	private final static String CONST_MODEL_CLASS = "docuSign.action.SignSubmitAction";
