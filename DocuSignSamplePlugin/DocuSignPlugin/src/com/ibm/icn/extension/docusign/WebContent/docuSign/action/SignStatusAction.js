...
define(["dojo/_base/declare",  "dojo/_base/lang", "dojo/json", "ecm/model/Action",  "ecm/model/Request",  "../dialog/LoginDialog",			"../dialog/DocumentStatus"],
	 ...
	 */
	return declare("docuSign.action.SignStatusAction", [ Action ], {
	/** @lends docuSign.action.SignStatusAction.prototype */
	
		performAction: function(repository, items, callback, teamspace, resultSet, parameterMap) 
		{
			this._getDocumentStatus(items);
		},
		
		_getDocumentStatus: function(items, requestData)
		{
			var self = this;
			var payLoadObject = {requestType: "Get", id: items[0].id};
			Request.invokePluginService("DocuSignPlugin", "SignStatusService", {
				requestParams: {
