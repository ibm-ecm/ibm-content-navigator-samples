...
public class CheckinAction extends PluginAction {

	private final static String CONST_ACTION_ID = "docuSign.action.CheckinAction";
	private final static String CONST_MODEL_CLASS = "docuSign.action.CheckinAction";
	...
	public String getName(Locale locale) {
		return "Checkin Signed Document";
	}
