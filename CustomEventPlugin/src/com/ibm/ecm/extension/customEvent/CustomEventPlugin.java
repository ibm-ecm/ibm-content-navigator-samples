 ...
 * <p>
 */
public class CustomEventPlugin extends Plugin {
	...
	public String getConfigurationDijitClass() {
		return "customEventPluginDojo.ConfigurationPane";
	}
	...
	public PluginService[] getServices() {
		if (pluginServices.length == 0) {
			pluginServices = new PluginService[] {new com.ibm.ecm.extension.customEvent.RaiseEventService()};
		}
