...
define([
	"dojo/_base/lang",
	"dojo/i18n!customEmailPluginDojo/nls/messages",
], function(lang, messages) {
    var customEmailPlugin = lang.getObject("CustomEmailPlugin", true);
    customEmailPlugin.messages = messages;
    return customEmailPlugin.messages;
});