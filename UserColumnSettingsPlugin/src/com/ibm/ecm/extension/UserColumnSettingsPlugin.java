 ...
 * <p>
 */
public class UserColumnSettingsPlugin extends Plugin {
	 ...
	 */
	public String getId() {
		return "UserColumnSettingsPlugin";
	}
	...
	public String getScript() {
		return "UserColumnSettings.js.jgz";
	}
	...
	public String getCSSFileName() {
		return "UserColumnSettings.css.jgz";
	}
	...
	public String getConfigurationDijitClass() {
		return "userColumnSettingsDojo.ConfigurationPane";
	}
	...
	public PluginAction[] getActions() {
		if (pluginActions.length == 0) {
			pluginActions = new PluginAction[] {new com.ibm.ecm.extension.DisplayedColumnPreferences()};
		}
	...
	public PluginService[] getServices() {
		if (pluginServices.length == 0) {
			pluginServices = new PluginService[] {new com.ibm.ecm.extension.UserSettingsService()};
		}
