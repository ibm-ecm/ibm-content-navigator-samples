...
define([
	...
	var searchCriteriaValidatorPlugin = lang.getObject("searchCriteriaValidatorPlugin", true);
	searchCriteriaValidatorPlugin.messages = messages;
	return searchCriteriaValidatorPlugin.messages;
});