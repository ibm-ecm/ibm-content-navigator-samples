 ...
 * <p>
 */
public class SetSameSitePlugin extends Plugin {
	...
	public String getName(Locale locale) {
		return "Set SameSite for cookie set by ICN web page";
	}
	...
	public String getConfigurationDijitClass() {
		return "setSameSitePluginDojo.ConfigurationPane";
	}
